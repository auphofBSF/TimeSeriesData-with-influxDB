...
## 1. Configure the Docker to not require sudo
```
synogroup --add docker {your-user1} {your-user2} {your-userN}
chown root:docker /var/run/docker.sock
```
CAUTION: beaware of the security Risk. THis needs some attention
